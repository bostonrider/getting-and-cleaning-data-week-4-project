...
1. Read the files and merging the training data set and testing data set to create on data set
  ...
  (2) read subject_train.txt: volunteer training subjects being observed
  
  (3) read subject_test.txt: volunteer testing subjects being observed
...
2. Merge tarining set and testing set to create on data set.
...
6.From the data set in step 5, creates a second, independent tidy data set with the average of each variable for each activity and each subject.
 final tidy data set called "tidy_data.txt"
